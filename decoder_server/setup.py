...
# compiler_args = (
#     ["/std:c++17", "/D_USE_MATH_DEFINES"] if sys.platform == "win32" else ["-std=c++17"]
# )
...
#     if not file.endswith("_decoder.cpp") and not file.endswith(".pyx.cpp")
# ]
...
#         [
#             "decoder/cython/suffix_decoder.pyx",
...
#         "decoder.cython.trie",
#         [
#             "decoder/cython/trie.pyx",
#             "decoder/cython/trie.cpp",
#             "decoder/cython/prefixTree.cpp",
#         ],
#         extra_compile_args=compiler_args,
#         language="c++",
